...
//        setProps();
        ...
        logout.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                try {
                    ...
                    Toast.makeText(UserActivity.this, "로그아웃 URL 인코딩 오류", Toast.LENGTH_SHORT).show();
                } catch (MalformedURLException e) {
                    Toast.makeText(UserActivity.this, "잘못된 URL", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
        });
    ...
    private void userLogout() throws UnsupportedEncodingException, MalformedURLException {
        // 로그아웃 URL
        ...
        String url = apiUrl + "/login/logout";
         ...
         String urlString = url + "?userId=" + encodedParam;
         URL logoutUrl = new URL(urlString);
